...
func main():
    ...
    # Get the value of the frame pointer register (fp) so that we
    # can use the address of loc_tuple
    let (__fp__, _) = get_fp_and_pc()
    # Since the tuple elements are next to each other, we can use
    # the tuple's address
...
func verify_location_list(loc_list : Location*, n_steps):
    ...
    # There is always one more location than steps
